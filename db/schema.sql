-- ARC schema — milestone 1: event log + rebuildable rollup.
...
CREATE INDEX IF NOT EXISTS events_logical_day_idx ON events (logical_day);
CREATE INDEX IF NOT EXISTS events_type_idx ON events (type);
CREATE INDEX IF NOT EXISTS events_domain_idx ON events (domain) WHERE domain IS NOT NULL;
